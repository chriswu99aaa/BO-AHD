...
class BayesianOptimizer():
    ...
    def embed_code(self, code):
        ...
        try:
            ...
            return np.zeros(1536)  # text-embedding-ada-002的维度，但实际使用Qwen text-embedding-v4配置为1536维
    ...
    def fit(self):
        ...
        print(f"[GP Fit] Starting GP model fitting with {len(self.X)} data points, feature dimension: {train_x.shape[-1]}")
        ...
        print(f"[GP Fit] GP model fitting completed")
